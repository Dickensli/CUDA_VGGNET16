...
set(NVML_TOP_DIR "/usr/local/cuda-9.0")
endif (WIN32)
...
FIND_LIBRARY(NVML_DEBUG_LIBRARIES NAMES nvidia-ml
   PATHS
	 ${NVML_TOP_DIR}/lib/x64
	 ${NVML_TOP_DIR}/lib64/stubs
)

FIND_LIBRARY(NVML_RELEASE_LIBRARIES NAMES nvidia-ml
   PATHS
	 ${NVML_TOP_DIR}/lib/x64
	 ${NVML_TOP_DIR}/lib64/stubs
)
